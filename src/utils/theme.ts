...
const createBaseColors = (appTheme: AppTheme): MD3BaseColors => {
  ...
  return {
    ...
    onSurfaceVariant: '#3B5998',
    outline: withOpacity(md3BaseColors.primary!, 0.15),
    outlineVariant: '#BFDBFE',
    // Additional required MD3 colors
    surfaceDisabled: withOpacity('#DBEAFE', 0.12),
    onSurfaceDisabled: withOpacity('#1E3A8A', 0.38),
    inverseSurface: '#1E40AF',
    inverseOnSurface: '#EFF6FF',
    inversePrimary: '#BFDBFE',
    inverseSecondary: '#BAE6FD',
    shadow: '#000000',
    scrim: 'rgba(0, 0, 0, 0.25)',
    backdrop: 'rgba(30, 58, 138, 0.6)',
  };
};
